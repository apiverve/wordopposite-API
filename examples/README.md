# Word Opposites API - Examples

This folder contains example code for using the Word Opposites API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/wordopposite',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/wordopposite");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/wordopposite](https://docs.apiverve.com/ref/wordopposite)
